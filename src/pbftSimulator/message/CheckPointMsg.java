...
public class CheckPointMsg extends Message{
	...
	public CheckPointMsg(int v, int n, Map<Integer, LastReply> s, int i, int sndId, int rcvId, long receiveTime) {
	...
	public Message copy(int rcvId, long receiveTime) {
		...
		return new CheckPointMsg(v, n, s, i, sndId, rcvId, receiveTime);
	}
